...
5.times do
    ...
    Alert.create(movie_id: Movie.all[0].id, user_id: User.all.sample.id)
    Alert.create(movie_id: Movie.all[1].id, user_id:  User.all.sample.id)
    Alert.create(movie_id: Movie.all[2].id, user_id:  User.all.sample.id)
end
